...
void print(char aut[64][64]);
void printMat(int matrix[2][32]);
int clnAlf(int matrix[2][32]);
...
void printMat(int arr[2][32]){
    for(int b=0; b<31 && arr[1][b]!='\0'; b++){
        printf("%d %c\n", arr[0][b], arr[1][b]);
    }
}
void print(char aut[64][64]){
